...
function TellUsMore() {
  return (
    <>
      <section className="bg_blur_black">
        <div className="container py-4 py-sm-5">
          <div className="row align-items-center">
            <div className="my-2 my-lg-0 col-lg-6">
              <h4 className="mb-0 text-white ff_kon fw-normal fs_xxl">
                Tell us more....
              </h4>
              <p className="mb-0 text-white mt-2  fw-normal fs_sm ff_Gilroy">
            ...
            <div className="my-2 my-lg-0 col-lg-6">
              <div className=" align-items-center d-flex justify-content-between input_background w_75 w_lg_100 ms-lg-5">
                <input
                  type="text"
                  className="p-3 bg-transparent border-0 outline_none ff_Gilroy fw-normal fs_sm w-100  clr_darkwhite50"
              ...
              <div className="align-items-center mt-2 d-flex justify-content-between  w_75 w_lg_100 ms-lg-5">
                <a
                  className="text-white fs_sm fw-normal ff_Gilroy pe-1 pe-sm-0"
                  href="#"
                >
                  <span className="me-2">
                    <svg
                ...
                <a className="text-white fs_sm fw-normal ff_Gilroy" href="#">
                  Learn more about...
                </a>
              </div>
            </div>
